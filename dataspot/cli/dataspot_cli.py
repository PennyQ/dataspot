...
@click.option('--scripts_path', default=os.path.join(os.path.abspath('../../'), 'examples/usercase1'),
...
@click.option('--config_path', default=os.path.join(os.path.abspath('../'),'usercase1_config.json'),
